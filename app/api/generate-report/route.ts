...
3. Pendahuluan (politik, sosbud, ekonomi, keamanan):
   ...
   - PENTING: Untuk menghemat token dan mencegah teks terpotong (truncation), jika tidak ada data baru/spesifik terkait pendahuluan bidang tersebut di masukan pengguna, Anda diperbolehkan (dan disarankan) untuk mengisi nilai field pendahuluan tersebut dengan "-" (tanda hubung tunggal) saja. Sistem backend akan secara otomatis mengisi paragraf pendahuluan resmi yang lengkap dan baku.
   - Hanya jika ada data masukan/informasi spesifik baru dari pengguna, tulis teks pendahuluan secara detail dengan mengikuti format dan substansi berikut (sesuaikan nama bulan dan tahun secara dinamis berdasarkan tanggal pelaporan):
...
4. Fakta-fakta:
   - Aspek Sosial:
     ...
     - Tabel Daftar Harga Bahan Pokok (PENTING!):
       ...
       PENTING: Jika tidak ada informasi harga spesifik di masukan pengguna, Anda diperbolehkan (dan disarankan) untuk mengisi kolom harga kemarin ([komoditas]_kemarin) and hari ini ([komoditas]_hari_ini) dengan "-" saja. Sistem backend akan secara otomatis mempopulasikannya dengan harga pasar standar terbaru.
       Daftar komoditas:

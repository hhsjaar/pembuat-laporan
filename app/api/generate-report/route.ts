...
4. Fakta-fakta:
   - Aspek Sosial:
     ...
     - Sosial Budaya (fakta_sosial_budaya):
       ...
       Jika tidak ada kegiatan di input, cukup isi dengan "-".
   - Aspek Keamanan:
     ...
     - Lain-lain (lain_lain_text): Uraikan kegiatan menonjol lainnya seperti patroli Blue Light Patrol (BLP) siang/malam, termasuk waktu, cuaca, personil, sasaran, rute, dan hasil patroli yang disalin dari LHS secara lengkap. Jika tidak ada, cukup isi dengan "-".
